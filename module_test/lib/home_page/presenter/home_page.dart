...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final cubit = AppInject<HomeCubit>().getDependency(context);
    final permanent = AppInject<PermanentClass>().getDependency(context);
    final permanentFromModule =
        AppInject<PermanentClassHomeModule>().getDependency(context);
    const embeded =
        ...
        child: Center(
          child: Column(
            children: [
              ...
              Center(
                child: TextButton(
                  onPressed: () => permanentFromModule.permanentLog(),
                  child: const Text(
                    'Chamar função permanente do módulo',
                  ),
                ),
              ),
              SizedBox(
...
class Testando {
  teste(BuildContext context) {
    final teste = AppInject<HomeCubit>().getDependency(context);
    teste.callUseCase();
  }
}
